export default {
  ...
  "onboarding": {
    "page1_text": "Keep your pet's medical history always at hand.",
    "page2_text": "Generate a QR code for emergencies.",
  ...
  "home_new": {
    ...
    "ask_ai": "Ask AI",
    "my_diary": "My Diary",
    "banner_title": "Your Ideal Companion",
    "banner_subtitle": "Care for and manage everything about your pets."
  },
  "pet_form": {
    "add_title": "Register New Pet",
    "edit_title": "Edit Pet",
    ...
    "markings": "Markings",
    "chip_id": "Chip ID",
    "medical_info_section": "Medical Info",
    "weight_kg": "Weight (kg)",
    "height_cm": "Height (cm)",
    "allergies": "Allergies",
    ...
    "owner_info_section": "Owner Info",
    "owner_name": "Name",
    "phone": "Phone",
    "email": "Email",
    "save_button": "Save Pet",
    "add_photo_button": "Add Photo",
    "unnamed": "Unnamed",
    "no_species": "Species not defined",
    "select_image_title": "Add Photo",
  ...
  "common": {
    ...
    "fetch_error": "Error loading record",
    "loading": "Loading...",
  ...
  "qrDetail": {
    "title": "QR Code",
    "scanInstruction": "Scan this code to see {{petName}}'s medical record. You can print it and place it on their collar.",
    "viewButton": "View Data",
    "shareButton": "Share",
    "downloadButton": "Download",
    "download_success_message": "QR saved to gallery!",
    "download_error_message": "Error saving QR.",
    "share_title": "{{petName}}'s QR Code",
    "share_error_message": "Error sharing QR."
  },
  "app": {
    "name": "VitaPet's"
  },
  ...
  "allergy_screen": {
    "title": "Allergies for {{petName}}",
    "add_button": "Add Allergy"
  },
  "add_allergy_form": {
    "title": "Add Allergy",
    "allergy_name": "Allergy Name",
    "allergy_name_placeholder": "e.g., Pollen, Flea bite",
    "date": "Date Detected",
  ...
  "surgery_screen": {
    ...
    "add_button": "Add Surgery",
    "no_surgeries_message": "No surgeries recorded."
  },
  "add_surgery_form": {
    "title": "Add Surgery",
    "edit_title": "Edit Surgery",
    "surgery_name": "Surgery Name",
    "surgery_name_placeholder": "e.g., Sterilization",
  ...
  "surgery_detail_screen": {
    ...
    "clinic_label": "Clinic:",
    "delete_alert_title": "Delete Surgery",
    "delete_alert_message": "Are you sure you want to delete \"{{name}}\"? This action cannot be undone.",
    "delete_success_message": "Record deleted successfully.",
    "delete_error_message": "Could not delete record."
  },
  "exam_screen": {
    "title": "Exams for {{petName}}",
    "add_button": "Add Exam",
    "no_exams_message": "No exams recorded."
  },
  "add_exam_form": {
    "title": "Add Exam",
    "edit_title": "Edit Exam",
    "exam_name": "Exam Name",
    "exam_name_placeholder": "e.g., Blood test",
    "date": "Date of Exam",
    "vet_name": "Veterinarian",
    "clinic_name": "Clinic",
    "results": "Results",
    "attachments": "Attach Document",
    "upload_prompt": "Tap to upload a file"
  },
  "exam_detail_screen": {
    "title": "Exam Detail",
    "exam_label": "Exam:",
    ...
    "delete_alert_title": "Delete Exam",
    "delete_alert_message": "Are you sure you want to delete \"{{name}}\"? This action cannot be undone."
  },
  "medicine_screen": {
    "title": "Medications for {{petName}}",
    "add_button": "Add Medication",
    "no_medicines_message": "No medications recorded."
  },
  "add_medicine_form": {
  ...
  "medicine_detail_screen": {
    ...
    "notes_label": "Notes:",
    "delete_alert_title": "Delete Medication",
    "delete_alert_message": "Are you sure you want to delete \"{{name}}\"? This action cannot be undone."
  },
  "parasite_treatment_screen": {
    "title": "Parasite Treatments for {{petName}}",
    "add_button": "Add Treatment",
    "no_treatments_message": "No treatments recorded.",
  ...
  "parasite_treatment_detail_screen": {
    ...
    "last_dose_date_label": "Last Dose:",
    "next_dose_date_label": "Next Dose:",
    "notes_label": "Notes:",
